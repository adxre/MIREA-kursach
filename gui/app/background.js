...
const createWindow = (windowName, options) => {
  ...
  const browserOptions = _objectSpread(_objectSpread(_objectSpread({}, options), state), {}, {
    ...
    webPreferences: _objectSpread({
      preload: path__WEBPACK_IMPORTED_MODULE_13__.join(__dirname, '../app/preload.js'),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createWindow);
...
var _Symbol$toPrimitive = __webpack_require__(/*! @babel/runtime-corejs3/core-js/symbol/to-primitive */ "./node_modules/@babel/runtime-corejs3/core-js/symbol/to-primitive.js");
...
(async () => {
  ...
  electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.on('request-reload', event => {
    const webWin = electron__WEBPACK_IMPORTED_MODULE_0__.BrowserWindow.fromWebContents(event.sender);
